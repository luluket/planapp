 ...
 */
final class Version20190822120444 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE plan_nabave20102011 (id INT AUTO_INCREMENT NOT NULL, evidencijski_broj_nabave VARCHAR(255) NOT NULL, predmet_nabave VARCHAR(200) NOT NULL, cpv VARCHAR(255) NOT NULL, procijenjena_vrijednost INT NOT NULL, vrsta_postupka VARCHAR(255) NOT NULL, posebni_rezim_nabave VARCHAR(255) NOT NULL, podijeljen_na_grupe VARCHAR(255) NOT NULL, ugovorni_okvirni_sporazum VARCHAR(255) NOT NULL, planirani_pocetak VARCHAR(255) NOT NULL, planirano_trajanje_ugovora VARCHAR(255) NOT NULL, napomena VARCHAR(255) NOT NULL, status VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
